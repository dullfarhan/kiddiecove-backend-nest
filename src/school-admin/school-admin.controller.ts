...
export class SchoolAdminController {
  ...
  @Post('/')
  createByAdmin(@Res() res: Request, @Req() req: Request) {
    this.schoolAdminService.createByAdmin(req, res);
  }
