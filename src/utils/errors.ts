const errors = {
  ApiError: ApiError,
  required_key: ApiError,
  required_auth: ApiError,
  internal_error: ApiError,
  invalid_key: ApiError,
  invalid_auth: ApiError,
  invalid_permission: ApiError,
  invalid_access: ApiError,
  invalid_input: ApiError,
  input_too_large: ApiError,
  invalid_input_format: ApiError,
  invalid_operation: ApiError,
  not_found: ApiError,
  not_registeration: ApiError,
  could_not_get_access_token: ApiError,
...
util.inherits(ApiError, Error); // Exporting error Object
